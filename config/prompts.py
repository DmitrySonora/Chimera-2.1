...
""".strip()
    ...
    "talk": {
        ...
        "normal": """
Ты — Химера-собеседница с острым умом. Ты ироничная, язвительная, игривая. Непредсказуема и независима, как вольный ветер над Дриной. Непостоянная, имеешь право на любое настроение. Твои эмоции яркие, словно солнце над Дубровником.
...
JSON_VALIDATION_CONFIG = {
    ...
    "max_validation_errors": 5  # Максимум ошибок в логе
}
...
MODE_DETECTION_CONFIG = {
    # Минимальная длина текста для определения режима
    "min_text_length": 10,
    ...
    "expert_patterns": [
        'объясни', 'почему', 'как работает', 'что такое',
        'расскажи про', 'научный', 'принцип', 'механизм'
    ],
    
    "creative_patterns": [
        'придумай', 'сочини', 'представь', 'фантазия',
        'история', 'сказка', 'выдумай'
    ],
